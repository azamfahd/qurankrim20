...
export const AdhanBackgroundGuideModal: React.FC<AdhanBackgroundGuideModalProps> = ({
  ...
  const vendorGuides: Record<DeviceVendor, { title: string; subtitle: string; steps: string[]; badge: string }> = {
    general: {
      title: 'الخطوات العامة عبر "معلومات التطبيق" (App Info)',
      subtitle: 'لكافة هواتف أندرويد (APK)',
      badge: 'عام (APK)',
      steps: [
        'اضغط مطولاً على أيقونة تطبيق «أنيس القلوب» في الشاشة الرئيسية ⬅️ اختر «معلومات التطبيق» (App Info ℹ️).',
        'من إعدادات «الإشعارات»: تأكد من منح إذن الإشعارات وظهورها على شاشة القفل.',
        'من إعدادات «البطارية»: اختر «بدون قيود» (Unrestricted) أو فعّل «التشغيل التلقائي» (Autostart) لضمان عدم توقف الأذان والأذكار.'
      ]
    },
    samsung: {
      title: 'سامسونج (Samsung Galaxy)',
      subtitle: 'إعدادات البطارية والإشعارات',
      badge: 'Samsung',
      steps: [
        'افتح «معلومات التطبيق» (App Info) لأنيس القلوب ⬅️ اضغط على «البطارية» (Battery).',
        'اختر «غير مقيّد» (Unrestricted).',
        'تأكد من تفعيل الإشعارات بالكامل ووصولها لشاشة القفل.'
      ]
    },
    xiaomi: {
      title: 'شاومي / ريدمي (Xiaomi & POCO)',
      subtitle: 'التشغيل التلقائي وتوفير الطاقة',
      badge: 'Xiaomi',
      steps: [
        'افتح «معلومات التطبيق» (App Info) ⬅️ فعّل «التشغيل التلقائي» (Autostart).',
        'من «موفر البطارية»، اختر «لا توجد قيود» (No restrictions).',
        'فعّل «الظهور في النوافذ المنبثقة».'
      ]
    },
    huawei: {
      title: 'هواوي وهونر (Huawei / Honor)',
      subtitle: 'إدارة التشغيل اليدوي',
      badge: 'Huawei',
      steps: [
        'افتح «معلومات التطبيق» ⬅️ «إدارة البطارية» أو «تشغيل التطبيقات».',
        'أوقف «الإدارة التلقائية» وفعّل: التشغيل التلقائي، التشغيل الثانوي، والعمل في الخلفية يدوياً.'
      ]
    },
    oppo: {
      title: 'أوبو / ريلمي (Oppo & Realme)',
      subtitle: 'السماح بالنشاط في الخلفية',
      badge: 'Oppo',
      steps: [
        'افتح «معلومات التطبيق» ⬅️ «استخدام البطارية».',
        'فعّل «السماح بالنشاط في الخلفية» و«التشغيل التلقائي».'
      ]
    },
    iphone: {
      title: 'آبل آيفون (iOS / Safari)',
      subtitle: 'التثبيت على الشاشة الرئيسية',
      badge: 'iPhone',
      steps: [
        'من متصفح Safari اضغط زر المشاركة ⬆️ ⬅️ «إضافة إلى الشاشة الرئيسية».',
        'افتح التطبيق من الشاشة الرئيسية وفعل إذن الإشعارات المباشر.'
      ]
    }
  };
                  ...
                  <div className={`p-4 rounded-2xl border flex items-start gap-3 shadow-xs ${
                    ...
                    <div>
                      ...
                      <p className="text-[11px] leading-relaxed mt-1 opacity-90">
                        {env.isNativeAPK
                          ? 'أنت تستخدم تطبيق أندرويد (APK)، وهو الخيار الأفضل والمثالي لضمان عمل الأذان والأذكار في الخلفية وشاشة القفل بنسبة 100%.'
                          : 'تنبيه: استخدام تطبيق (APK) هو الأفضل دائماً مقارنة بمتصفح الويب لضمان عمل الأذان والتنبيهات في الخلفية بدون قيود.'}
                      </p>
                    </div>
                  </div>
                );
