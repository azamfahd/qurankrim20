...
import { X, Download, Share2, Smartphone, Globe, CheckCircle2, Sparkles, Apple, ArrowRight, ShieldCheck, Zap, Info } from 'lucide-react';
    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        <motion.div
          ...
          className="relative w-full max-w-lg bg-gradient-to-b from-slate-900 via-[#032019] to-slate-950 text-white rounded-3xl shadow-2xl border border-amber-500/30 overflow-hidden flex flex-col max-h-[90vh] z-10"
          dir="rtl"
            ...
            <div className="flex items-center gap-3.5">
              ...
              <div>
                ...
                <p className="text-xs text-amber-200/80 font-medium mt-0.5">
                  اختر الخيار المناسب لتثبيت تطبيق أنيس القلوب على جهازك
                </p>
              </div>
            </div>
              ...
              <div className="space-y-4 animate-in fade-in duration-300">
                <div className="p-4 rounded-2xl bg-amber-950/30 border border-amber-500/30 space-y-2">
                  <div className="flex items-center gap-2 text-amber-300 font-black text-sm">
                    ...
                    <span>تطبيق الويب التقدمي (Progressive Web App)</span>
                  </div>
                  <p className="text-xs text-slate-300 leading-relaxed">
                ...
                {deferredPrompt ? (
                  ...
                  >
                    <Download size={18} />
                    <span>إضافة التطبيق للشاشة الرئيسية فوراً</span>
                  </button>
                ) : (
                  <div className="p-4 rounded-2xl bg-white/[0.04] border border-white/10 space-y-2 text-xs">
                    <p className="font-bold text-amber-300">خطوات التثبيت من المتصفح (Chrome / Edge / Samsung):</p>
