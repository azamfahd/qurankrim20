...
import { Download, Smartphone, Sparkles, X, ShieldCheck, Zap } from 'lucide-react';
          ...
          >
            ...
            <div className="flex items-start justify-between gap-3 relative z-10">
              <div className="flex items-start gap-3">
                ...
                >
                  {isMajor ? <Sparkles size={22} className="text-slate-950" /> : <Zap size={22} className="text-slate-950" />}
                </div>

                <div>
                  <div className="flex items-center gap-2 flex-wrap">
                    <h4 className="text-sm sm:text-base font-black text-white flex items-center gap-1.5">
                      <span>{versionInfo?.title || (isMajor ? 'تحديث جديد وإصدار رئيسي' : 'تحديث بسيط وتحسينات جودة')}</span>
                    </h4>
                    <span
                  ...
                  <p className="text-xs text-emerald-100/90 mt-1.5 leading-relaxed font-medium">
                    {versionInfo?.releaseNotes ||
                      (isMajor
                        ? 'يتوفر إصدار جديد يحتوي على ميزات رئيسية جديدة وتصميمات وتحديثات شاملة للتطبيق.'
                        : 'يتوفر تحديث بسيط يتضمن تحسينات سريعة في الأداء والاستقرار ودقة المواقيت.')}
                  </p>
                  ...
                  {versionInfo?.sizeFormatted && (
                    <div className="flex items-center gap-1 text-[11px] text-amber-200/90 font-medium mt-1.5">
                      ...
                      <span>حجم التحديث: {versionInfo.sizeFormatted} • تحميل وتثبيت مباشر</span>
                    </div>
                  )}
                </div>
              </div>
            ...
            <div className="flex items-center gap-2.5 mt-4 pt-3 border-t border-emerald-500/30 relative z-10">
              ...
              >
                ...
                <span>طلب التحديث وتحميله الآن</span>
              </button>
